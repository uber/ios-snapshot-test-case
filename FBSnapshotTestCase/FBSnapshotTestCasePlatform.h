...
/**
 ...
 - FBSnapshotTestCaseAgnosticOptionScreenScale: The file name should not have a suffix concatenated to it regarding the dimension ("@2x" or "@3x", for instance).
 */
typedef NS_OPTIONS(NSUInteger, FBSnapshotTestCaseAgnosticOption) {
  ...
  FBSnapshotTestCaseAgnosticOptionScreenScale = 1 << 4
};
